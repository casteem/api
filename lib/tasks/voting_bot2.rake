...
task :voting_bot2 => :environment do |t, args|
  ...
  POWER_ADDED_PER_MOD_COMMENT = 0.65
  ...
  logger.log "\n==========\nTotal #{original_post_size} posts -> #{verified_and_active_count} verified and active -> #{valid_posts_size} valid for voting -> #{posts.size} selected\n"
